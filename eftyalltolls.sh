...
#       GitTool v1.0 
#  
#             GitTool Create By : Efty
#             Youtube Channel : https://www.youtube.com/c/Efty
#             GitHub : https://github.com/Efty
#             website : https://Eftywordpress.com/
...
echo ""
echo -e $cyan"    Create by           $white":" $red Efty  "
echo -e $cyan"    Youtube Channel     $white":" $red https://www.youtube.com/c/efty"
echo -e $cyan"    Github              $white":" $red https://github.com/EftyForid"
echo -e $cyan"    website             $white":" $red https://Efty.wordpress.com/"
echo -e $cyan ""
echo -e $okegreen"   ====================== Tool Lest =======================    ";
        ...
        case "$option" in 
           ...
           14)  echo "fluxion"
                ...
                clear
                ;;
            q)  echo -e $yellow " Thanks For Using My Tools Good Bye  {Efty}  !!"
                echo
                exit 0 
                ;;
        esac
